<?php
    ...
    $cliente = mysqli_query($conn, "SELECT * FROM cliente WHERE cpf = $cpf");
    ...
    if (isset($pega_cliente['idCliente']) && $cadastro_pet['nome_pet'] == 0) {

        $id_cliente = $pega_cliente['idCliente'];
        ...
        header('Location: ../cadastro_pets.php');
    }
    else {
        if(!isset($pega_cliente['idCliente'])){
            $_SESSION['msg_cad_pet'] = "<center><span style='color:red;'>Falha ao cadastrar. Cliente não encontrado.</span></center>";
